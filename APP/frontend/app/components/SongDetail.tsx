    ...
    <div className="h-full flex flex-col">
      ...
      <div className="px-8 py-5 border-b border-surface-border bg-surface-light/50">
        <div className="flex items-center gap-4">
          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-accent-orange/20 to-accent-pink/15 flex items-center justify-center">
          ...
          <div>
            ...
            <p className="text-xs text-muted-dim mt-1">
              ...
              {track.score && <span className="ml-3 text-accent-orange font-semibold">{track.score}分</span>}
            </p>
          </div>
        </div>
      </div>
          ...
          <button
            ...
            className={`px-5 py-3 text-xs font-medium transition-colors border-b-2 -mb-px ${
              i === activeTab
                ...
                : 'text-muted-dim border-transparent hover:text-muted'
            }`}
          >
            {label}
          </button>
        ...
        {activeTab === 0 && (
          <div className="max-w-2xl space-y-6">
            <div className="card p-5">
              <h3 className="text-sm font-semibold text-white mb-4">中文歌词</h3>
              <pre className="font-mono text-sm text-muted leading-relaxed whitespace-pre-wrap">
{'[Verse]\n第一行歌词内容\n第二行歌词内容\n\n[Pre Chorus]\n过渡段落\n\n[Hook]\n副歌核心句子\n重复加强记忆'}
              </pre>
              <div className="text-xs text-muted-dim mt-3">字数: 1,234 / 3,500</div>
            </div>
            <div className="card p-5">
              <h3 className="text-sm font-semibold text-white mb-4">English Lyrics</h3>
              <pre className="font-mono text-sm text-muted leading-relaxed whitespace-pre-wrap">
{'[Verse]\nFirst line of lyrics\nSecond line\n\n[Hook]\nThe chorus hook line'}
              </pre>
              <div className="text-xs text-muted-dim mt-3">Chars: 890 / 3,500</div>
            </div>
          </div>
        )}
          ...
          <div className="space-y-6 max-w-3xl">
            <div className="card p-5">
              <div className="flex items-center gap-6 mb-4">
                <div><span className="text-xs text-muted-dim">BPM</span><p className="text-white font-semibold">78</p></div>
                <div><span className="text-xs text-muted-dim">Key</span><p className="text-white font-semibold">Am</p></div>
                <div><span className="text-xs text-muted-dim">Style</span><p className="text-white font-semibold">Alternative Pop</p></div>
              </div>
            </div>
            {[
            ...
            <div className="card overflow-hidden">
              <table className="w-full text-sm">
                ...
                <tbody className="text-muted">
                  <tr className="border-b border-surface-border">
                    <td className="p-4 text-white font-medium">Vinyl Crackle</td><td className="p-4">Subtle vinyl noise for warmth</td><td className="p-4">Intro, Outro</td><td className="p-4 text-right">-24dB</td>
                  </tr>
                  <tr className="border-b border-surface-border">
                    <td className="p-4 text-white font-medium">Reverse Reverb</td><td className="p-4">Reverse reverb swell into chorus</td><td className="p-4">Pre-Chorus → Chorus</td><td className="p-4 text-right">-12dB</td>
                  </tr>
                  <tr className="border-b border-surface-border">
                    <td className="p-4 text-white font-medium">String Swell</td><td className="p-4">Gradual string section crescendo</td><td className="p-4">Chorus (1:42)</td><td className="p-4 text-right">-8dB</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div className="max-w-2xl space-y-6">
            <div className="card overflow-hidden">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-surface-border">
                    <th className="text-left p-4 text-xs text-muted-dim">Rhyme</th><th className="text-left p-4 text-xs text-muted-dim">Sound</th><th className="text-left p-4 text-xs text-muted-dim">Position</th><th className="text-left p-4 text-xs text-muted-dim">Emotion</th>
                  </tr>
                </thead>
                <tbody className="text-muted">
                  <tr className="border-b border-surface-border"><td className="p-4 text-white">-ang</td><td className="p-4">开口呼</td><td className="p-4">Verse, Hook</td><td className="p-4">释放、开阔</td></tr>
                  <tr className="border-b border-surface-border"><td className="p-4 text-white">-u</td><td className="p-4">合口呼</td><td className="p-4">Bridge</td><td className="p-4">内敛、低沉</td></tr>
                </tbody>
              </table>
            </div>
            <div className="card p-5">
          ...
          <div className="max-w-2xl space-y-6">
            <div className="card p-5">
                  ...
                  return (
                    <div key={dim}>
                      ...
                      <div className="h-2 bg-surface-border rounded-full overflow-hidden">
                        <div
                          className="h-full rounded-full bg-gradient-to-r from-accent-orange to-accent-pink transition-all"
                          style={{ width: `${pct}%` }}
                        />
                      </div>
                    </div>
              ...
              <div className="border-t border-surface-border mt-6 pt-4 flex justify-between items-center">
                ...
                <span className="text-2xl font-bold text-accent-orange">85/100</span>
              </div>
            </div>
          </div>
        )}
