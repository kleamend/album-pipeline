...
| 📦 **One-Click Packaging** | Cover concept, artist story, promotional docs, and platform compliance checks |
...
Phase 5: Audio Transcoder       → Listener selection + 320kbps / 44.1kHz transcoding
           ↓
Phase 6: Album Packager         → Cover + artist story + promo docs + platform checks
```
...
| 📦 Final Packager | Archives all deliverables |
...
├── phase6-platform-checker/              ← Phase 6.5: Platform compliance
├── phase6-packager/                      ← Phase 6.6: Final packager
...
- 🎵 **MiniMax Music** — high-quality Chinese music generation engine
...
| 📦 **一键发布打包** | 封面概念、艺人说、宣传文档、平台合规检查一体化 |
...
Phase 5: 音频转码            → 听评选定 + 320kbps / 44.1kHz 转码验证
           ↓
Phase 6: 专辑打包            → 封面 + 艺人说 + 宣传文档 + 平台适配检查
```
